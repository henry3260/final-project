...
composer.removeHidden()
    ...
    timer.performWithDelay( 3480, function() produce_beat(2) end,1 )
	timer.performWithDelay( 3880, function() produce_long_beat(3,8) end,1 )
   ...
   -- timer.performWithDelay( 6840, function() produce_beat(3) end,1 )
   -- timer.performWithDelay( 2840, function() produce_beat(4) end,1 )
    --timer.performWithDelay( 4440, function() produce_beat(1) end,1 )
    timer.performWithDelay( 5840, function() produce_beat(2) end,1 )
	--sheet music
	...
	timer.performWithDelay( 8800,  finish ,1 )
	timer.performWithDelay( 8800,  function()
